...
@router.get("/todo/{todo_id}", status_code=status.HTTP_200_OK, response_model=Todo)
...
@router.post("/todo", status_code=status.HTTP_201_CREATED, response_model=Todo)
...
@router.put("/todo/{todo_id}", status_code=status.HTTP_200_OK, response_model=Todo)
